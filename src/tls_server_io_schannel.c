    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                tls_io_instance->cert_context = CertFindCertificateInStore(hMyCertStore,
                    X509_ASN_ENCODING,
                    0,
                ...
                auth_data.cCreds = 1;
                auth_data.paCred = &tls_io_instance->cert_context;
            }
...
CONCRETE_IO_HANDLE tls_server_io_schannel_create(void* io_create_parameters)
{
    ...
    else
    {
        ...
        else
        {
            ...
            result->cert_context = CertCreateCertificateContext(X509_ASN_ENCODING, tls_server_io_config->certificate, tls_server_io_config->certificate_size);
